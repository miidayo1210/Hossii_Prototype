...
> **共有URL参加導線の正本:** [123_URLからスペース参加UI.md](./docs/123_URLからスペース参加UI.md) — `GuestEntryScreen` / `ParticipantLoginScreen` / Hossii 吹き出し / `participation_mode` の現行仕様は **123 を正**とする。本書と矛盾する場合は 123 を優先する。
...
> **123 との関係:** 参加前 UI・ウェルカム表示・参加方法設定の詳細は [123](./docs/123_URLからスペース参加UI.md) を参照。本書はニックネーム入力 UX の課題整理（§問題1〜3）を残す。
...
> **123 を正とする:** 参加前の Hossii 吹き出し・共通 Hossii キャラの現行仕様は [123](./docs/123_URLからスペース参加UI.md) §8.2 / §11 を参照。本節は課題整理の履歴。
