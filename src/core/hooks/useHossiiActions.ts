...
export type HossiiActionsContextValue = Omit<HossiiContextValue, 'state' | 'spacesLoadedFromSupabase' | 'hossiiLoadedFromSupabase' | 'communitySlug' | 'myAuthorshipIds' | 'myAuthorshipIdsStatus'>;
